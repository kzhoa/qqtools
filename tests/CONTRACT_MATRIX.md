...
| qexp machine-local dynamic GPU admission policy, draining, and reservation linearization | [Policy Unit](unit/qexp/test_gpu_policy.py), [CLI and runtime Integration](integration/qexp/test_dynamic_gpu_policy.py) | qexp-unit / qexp-integration | covered |
...
| qexp finite CLI JSON/human output boundary and bounded presentation | [output architecture](unit/qexp/output/test_architecture.py), [family renderers](unit/qexp/output/test_families.py), [CLI dispatch](integration/qexp/test_output_format.py) | qexp-unit / qexp-integration | covered |
