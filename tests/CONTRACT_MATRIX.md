...
| CW-01 Submission Operation creation | Pending | [test_submission_protocol.py](integration/qexp/test_submission_protocol.py) | hermetic / qexp-fast | qexp maintainers |
| CW-02 Operation before Task staging | Pending | [test_scheduling_recovery_regressions.py](integration/qexp/test_scheduling_recovery_regressions.py) | hermetic / qexp-fast | qexp maintainers |
| CW-03 Partial Task staging | Pending | [test_batch_manifest_placement.py](integration/qexp/test_batch_manifest_placement.py) | hermetic / qexp-fast | qexp maintainers |
| CW-04 Worker addition before commit | Pending | [test_batch_manifest_placement.py](integration/qexp/test_batch_manifest_placement.py) | hermetic / qexp-fast | qexp maintainers |
...
| CW-07 Attempt before launch gate | Pending | [test_scheduling_recovery_regressions.py](integration/qexp/test_scheduling_recovery_regressions.py) | machine-lab / merge | qexp maintainers |
| CW-08 Launch gate before spawn | Pending | [test_scheduling_recovery_regressions.py](integration/qexp/test_scheduling_recovery_regressions.py) | OS / merge | qexp maintainers |
...
| CW-10 Process exit before terminal publish | Pending | [test_runner_pipeline.py](integration/qexp/test_runner_pipeline.py) | OS / merge | qexp maintainers |
| CW-11 Lease expiry before authorization | Pending | [test_scheduling_recovery_regressions.py](integration/qexp/test_scheduling_recovery_regressions.py) | hermetic / qexp-fast | qexp maintainers |
| CW-12 Lease expiry after authorization | Pending | [test_lease_hardening.py](integration/qexp/test_lease_hardening.py) | hermetic / qexp-fast | qexp maintainers |
