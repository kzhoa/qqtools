...
| qexp machine-local dynamic GPU admission policy, draining, and reservation linearization | [Policy Unit](unit/qexp/test_gpu_policy.py), [CLI and runtime Integration](integration/qexp/test_dynamic_gpu_policy.py) | [installed CLI](e2e/qexp/test_gpu_policy.py) | covered |
...
| qexp read-only continuous Task/progress/log observation and Attempt-bound tmux plain logs | [Unit](unit/qexp/test_continuous_observation.py), [CLI contract](integration/qexp/test_continuous_observation_cli.py), [real viewer processes](integration/qexp/test_continuous_observation_processes.py), [real tmux pane](integration/qexp/test_tmux_plain_log_observer.py) | [installed CLI](e2e/qexp/test_cli.py) / artifact E2E | covered |
