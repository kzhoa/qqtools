...
_LAZY_EXPORTS = {
    ...
    "ProjectSelection": ("submission_contracts", "ProjectSelection"),
    "SubmissionRequest": ("submission_contracts", "SubmissionRequest"),
    "SubmissionResult": ("submission_contracts", "SubmissionResult"),
    "resolve_submission_project": ("project_resolution", "resolve_submission_project"),
    ...
    "list_tasks_page": ("observer", "list_tasks_page"),
    "ObservationError": ("runtime.observation.api", "ObservationError"),
