...
def _resolve_eval_dedup_meta(args: Any, dataloader: DataLoader) -> tuple[bool, bool, tuple[str, ...]]:
    ...
    node_aligned_output_keys = tuple(_getattr_or_default(task_cfg, "node_aligned_output_keys", tuple()))
